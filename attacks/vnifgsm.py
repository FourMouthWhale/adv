...
def VNI_FGSM(model, criterion, original_images, labels, epsilon, num_iterations=10, decay=1, beta=1.5, N=0):
    """
    VNI-FGSM (Variance Tuning Nesterov Iterative Fast Gradient Sign Method)
